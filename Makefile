...
run:
	...
	appimagetool ${APPIMAGE_BUILD_DIR}/${APP_DIR}/

install:
	@sed "s?Exec=macosabout?Exec=${PWD}/MacOSAbout-x86_64.AppImage?g" assets/build_dependencies/MacOSAbout.desktop > /home/$$USER/.local/share/applications/MacOSAbout.desktop
